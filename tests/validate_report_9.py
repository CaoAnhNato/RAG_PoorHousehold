...
def validate():
    print("1. Đang sinh lại báo cáo số 9 năm 2024...")
    res = ReportGenerator.generate(report_id=9, year=2024)
    docx_path = Path("Runtime/reports/bao_cao_9_2024.docx")
    pdf_path = Path("Runtime/reports/bao_cao_9_2024.pdf")
    ...
    chart_files = [
        "report_9_chart_1.html",
        "report_9_chart_2.html",
        "report_9_chart_3.html"
    ]
    ...
    df, sql, title = execute_report_query(9, 2024)
    dist_ho_df = df[df["STT"].astype(str).str.isdigit()]
    ...
    print("\n=> TẤT CẢ KIỂM ĐỊNH BÁO CÁO SỐ 9 ĐẠT 100% CHUẨN XÁC!\n")
    return True
