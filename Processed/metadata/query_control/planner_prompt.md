...
Hướng dẫn ánh xạ nhanh:
- "số lượng hộ nghèo", "số hộ nghèo", "tổng số hộ nghèo" -> sử dụng metric 'poor_household_count'.
- "số lượng hộ cận nghèo", "hộ cận nghèo" -> sử dụng metric 'near_poor_household_count'.
- "tổng số hộ", "số lượng hộ", "số hộ" -> sử dụng metric 'household_count'.
- "số lượng thành viên", "số nhân khẩu", "tổng số thành viên" -> sử dụng metric 'member_count'.
- "điểm B1", "b1 trung bình" -> sử dụng metric 'avg_b1_score'.
- "điểm B2", "b2 trung bình" -> sử dụng metric 'avg_b2_score'.

Tín hiệu trích xuất bằng luật (Rule-extracted signals):
{rule_signals}
